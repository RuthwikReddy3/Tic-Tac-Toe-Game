A simple Tic Tac Toe game implemented using React.js. The game supports two players, displays the current turn, announces the winner or a draw, and provides a reset option.
